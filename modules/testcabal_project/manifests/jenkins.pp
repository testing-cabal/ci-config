...
class testcabal_project::jenkins (
  ...
  class { '::jenkins::master':
    ...
    jenkins_ssh_public_key  => $testcabal_project::jenkins_ssh_key,
  }
...
#  }
  ...
  if $manage_jenkins_jobs == true {
    class { '::jenkins::job_builder':
      ...
      username => 'lifeless', # This is not a typo, well it isn't anymore.
    ...
    file { '/etc/jenkins_jobs/config':
      ...
      recurse => true,
      source  =>
        'puppet:///modules/testcabal_project/jenkins_job_builder/config',
    ...
    file { '/etc/default/jenkins':
      ...
      group  => 'root',
      mode   => '0644',
      source => 'puppet:///modules/testcabal_project/jenkins/jenkins.default',
    }
  }
}
